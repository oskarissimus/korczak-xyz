 ...
 *
 * Adding a sixth is one file plus one line here — that is what the thin `RawEvent` contract in
 * types.ts buys. Two of these five are already generic (`rss` is driven by a URL list, `python-org`
...
import { elektroniczneZapisy } from './elektroniczneZapisy';
