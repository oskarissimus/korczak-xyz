...
| `.claude/rules/audio-guide.md` | The audio guide: the map and its pins, the one backend that is not in this repository, what a tap costs, the iOS audio unlock, the narration language |
