...
type MdxFrontmatter = {
  ...
  readonly featuredImageBW: Maybe<File>;
  readonly featuredImageColor: Maybe<File>;
  readonly language: Maybe<Scalars['String']>;
...
type MdxFrontmatterFieldSelector = {
  ...
  readonly featuredImageBW: InputMaybe<FileFieldSelector>;
  readonly featuredImageColor: InputMaybe<FileFieldSelector>;
  readonly language: InputMaybe<FieldSelectorEnum>;
...
type MdxFrontmatterFilterInput = {
  ...
  readonly featuredImageBW: InputMaybe<FileFilterInput>;
  readonly featuredImageColor: InputMaybe<FileFilterInput>;
  readonly language: InputMaybe<StringQueryOperatorInput>;
...
type MdxFrontmatterSortInput = {
  ...
  readonly featuredImageBW: InputMaybe<FileSortInput>;
  readonly featuredImageColor: InputMaybe<FileSortInput>;
  readonly language: InputMaybe<SortOrderEnum>;
...
type AboutPageQuery = { readonly oskarImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly locales: { readonly edges: ReadonlyArray<{ readonly node: { readonly ns: string | null, readonly data: string | null, readonly language: string | null } }> } };
...
type BlogPostsPageQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly excerpt: string | null, readonly frontmatter: { readonly slug: string | null, readonly title: string | null, readonly date: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> }, readonly locales: { readonly edges: ReadonlyArray<{ readonly node: { readonly ns: string | null, readonly data: string | null, readonly language: string | null } }> } };

type CoursePageQueryVariables = Exact<{
  slug: Scalars['String'];
  language: Scalars['String'];
}>;
...
type LogoQueryQuery = { readonly file: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null };

type MentoringImagesAndLocaleQueryVariables = Exact<{
  language: Scalars['String'];
}>;
...
type CreatePagesQuery = { readonly blogPosts: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly slug: string | null, readonly language: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> }, readonly courses: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly slug: string | null, readonly language: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> }, readonly songs: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly slug: string | null, readonly author: string | null, readonly title: string | null, readonly published: boolean | null, readonly language: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> }, readonly plugin: { readonly pluginOptions: Record<string, unknown> | null } | null };
