 ...
 *
 * It is optimistic by nature: a session revoked elsewhere still shows here until Firebase
 * says otherwise, a moment later. That is an acceptable trade for a label showing the user
 * their own address, and nothing is authorised on the strength of it.
 */
