...
export const ui = {
  en: {
    ...
    'pwa.shopping.short': 'Shopping',
    'pwa.events.short': 'Events',
    'pwa.transit.short': 'Metro',
    'pwa.sloper.short': 'Video',
    'pwa.backseat.short': 'Backseat',
    'pwa.audioGuide.short': 'Audio Guide',
    ...
    'shopping.desc': 'One list on both phones, and it works with no signal',
    'Events': 'Event Watch',
    ...
    'Sloper': 'Video Generation Wizard',
    'sloper.desc': 'A topic in, a narrated video out, on your own API keys',
    'Backseat': 'Annoying Passenger Simulator',
    'backseat.desc': 'Your phone watches the road and says the sort of thing a passenger says',
    'AudioGuide': 'Audio Guide',
    'audioGuide.desc': 'Tap a place on the map and hear what happened there, on your own API keys',
  ...
  pl: {
    ...
    'pwa.shopping.short': 'Zakupy',
    'pwa.events.short': 'Wydarzenia',
    'pwa.transit.short': 'Metro',
    'pwa.sloper.short': 'Wideo',
    'pwa.backseat.short': 'Pasażer',
    'pwa.audioGuide.short': 'Przewodnik',
    'pwa.offline.title': 'Offline',
    ...
    'shopping.desc': 'Jedna lista na dwóch telefonach, działa bez zasięgu',
    ...
    'Sloper': 'Kreator generowania wideo',
    'sloper.desc': 'Temat na wejściu, wideo z narracją na wyjściu, na twoich kluczach API',
    'Backseat': 'Symulator upierdliwego pasażera',
    'backseat.desc': 'Telefon patrzy na drogę i mówi to, co zwykle mówi pasażer',
    'AudioGuide': 'Audioprzewodnik',
    'audioGuide.desc': 'Dotknij miejsca na mapie i posłuchaj, co się tam wydarzyło, na twoich kluczach API',
