...
export const ui = {
  en: {
    ...
    'nightRoutine.desc': 'A bedtime checklist, printable on one A4 sheet',
    'nightRoutine.subtitle': 'Step by step to sleep',
    'nightRoutine.print': 'Print (A4)',
    'nightRoutine.hint': 'Prints as a single A4 portrait page. Turn on "Background graphics" in the print dialog to keep the colours.',
    'nightRoutine.goodnight': 'Good night',
    'nightRoutine.step.drink': 'Last drink',
    'nightRoutine.step.bath': 'Bath',
    'nightRoutine.step.nappy': 'Fresh nappy',
    'nightRoutine.step.pyjamas': 'Choosing the pyjamas',
    'nightRoutine.step.teeth': 'Brushing teeth',
    'nightRoutine.step.nose': 'Blowing the nose',
    'nightRoutine.step.wee': 'Last wee',
    'nightRoutine.step.book': 'Reading a book together',
    'nightRoutine.step.song': 'Singing together',
    'nightRoutine.step.lamp': 'Switching on the red lamp',
  ...
  pl: {
    ...
    'NightRoutine': 'Wieczorna rutyna',
    'nightRoutine.desc': 'Wieczorna checklista do wydruku na jednej kartce A4',
    'nightRoutine.subtitle': 'Krok po kroku do snu',
    'nightRoutine.print': 'Drukuj (A4)',
    'nightRoutine.hint': 'Drukuje się na jednej stronie A4 w pionie. Włącz "Grafikę tła" w oknie drukowania, żeby zachować kolory.',
    'nightRoutine.goodnight': 'Dobranoc',
    'nightRoutine.step.drink': 'Ostatnie picie',
    'nightRoutine.step.bath': 'Kąpiel',
    'nightRoutine.step.nappy': 'Pampers',
    'nightRoutine.step.pyjamas': 'Wybór piżamki',
    'nightRoutine.step.teeth': 'Mycie zębów',
    'nightRoutine.step.nose': 'Wydmuchanie nosa',
    'nightRoutine.step.wee': 'Ostatnie siku',
    'nightRoutine.step.book': 'Wspólne czytanie książeczki',
    'nightRoutine.step.song': 'Wspólne śpiewanie',
    'nightRoutine.step.lamp': 'Zapalenie czerwonej lampki',
