...
date: 2021-07-15
published: true
featuredImage: ../../../images/blog/led-matrix/tetris.png
language: en
---
...
![Tetris played on my DIY LED matrix](../../../images/blog/led-matrix/tetris.png)
...
<Gallery names={["controller-wiring", "controller-wiring-with-laptop", "controller-in-all-its-glory"]} />
...
<Gallery names={["nes-controller", "nespi", "raspberry-pi"]} />
