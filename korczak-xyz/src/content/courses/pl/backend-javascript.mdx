...
featuredImageColor: ../../../assets/images/courses/programowanie-backend-w-javascript-color.png
featuredImageBW: ../../../assets/images/courses/programowanie-backend-w-javascript-bw.png
language: pl
---
