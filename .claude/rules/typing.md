---
name: typing
description: The typing trainer at /apps/typing/ - lineage-based progress sync, Firestore client health, the localStorage budget, the book picker and frontend logging.
paths:
  - "**/utils/typing/**"
  - "**/components/Typing/**"
  - "**/hooks/useTypingSession.ts"
  - "**/styles/typing.css"
  - "**/pages/**/apps/typing.astro"
  - "**/pages/**/apps/typing/**"
  - "**/lib/firebase.ts"
  - "**/lib/firestoreHealth.ts"
  - "**/lib/logSink.ts"
  - "**/lib/logger.ts"
  - "**/lib/localStorage.ts"
  - "**/lib/authCache.ts"
